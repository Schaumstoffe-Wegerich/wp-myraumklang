              ...
              <div id="sl-frm" class="asl-form sl-row">
                  ...
                  <div class="pol-md-6">
                      <div class="sl-form-group sl-form-categories sl-group">
                          <label for="sl-categories" class="control-label"><?php echo __( 'Categories','asl_locator') ?></label>
                  ...
                  <div id="sl-grp-country" class="pol-md-6">
                      <div class="sl-form-group sl-group">
                          ...
                          <select class="form-control custom-select" id="sl-country" required name="country">
                            <option value=""><?php echo __( 'Select','asl_locator') ?></option>
                  ...
                  <div id="sl-grp-desc" class="pol-md-12">
                    <div class="sl-row">
                      <div class="pol-md-12">
                        <h3 class="sl-sub-title"><?php echo __( 'Additional Data','asl_locator') ?></h3>
                      </div>
                  ...
                  <div class="pol-md-12">
                      <div class="sl-form-group mt-3">
                          <a data-loading-text="<?php echo __( 'Registering...','asl_locator') ?>" class="btn btn-default btn-primary disabled" id="sl-btn-save"><?php echo __( 'Register','asl_locator') ?></a>
                      </div>
                  </div>
              </div>
          </div>
