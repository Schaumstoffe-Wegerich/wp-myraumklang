...
<div id="asl-list-tmpl" class="asl-cont asl-bg-<?php echo $all_configs['color_scheme'] ?> asl-text-<?php echo $all_configs['font_color_scheme'].$class; ?>">
    <div class="container">
                    ...
                    <div class="asl-search-cont">
                        <div class="asl-search-inner">
                            <div class="row no-gutters">
                                <div <?php if($all_configs['show_categories'] == '1'):?>class="col-md-5 col-sm-6"<?php else: ?>class="col-md-12"<?php endif; ?>>
                            ...
                            <div class="row asl-list-ddls asl-ddl-filters"></div>
                            <?php endif; ?>
                        </div>
