...
<style type="text/css">
  <?php echo $css_code; ?>
  .asl-p-cont .onoffswitch .onoffswitch-label .onoffswitch-switch:before {content: "<?php echo __('OPEN', 'asl_locator') ?>" !important;}
  .asl-p-cont .onoffswitch .onoffswitch-label .onoffswitch-switch:after {content: "<?php echo __('ALL', 'asl_locator') ?>" !important;}
                    ...
                    <div id="asl-list" class="asl-panel pol-md-5">
                      ...
                      <?php if($all_configs['advance_filter']): ?> 
                        ...
                        <div class="asl-categories-panel">
                          <div class="cats-title">
                            <h6><?php echo __('Categories', 'asl_locator') ?></h6>
                          </div>
                      ...
                      <div class="asl-panel-inner">
                        <div class="top-title Num_of_store">
                          ...
                          <a class="back-button"><?php echo __('Back', 'asl_locator') ?> <i class="icon-back"></i></a>
                        </div>
