            ...
            <div class="pol-lg-12">
                <div class="sl-row asl-search-widget text-center center-block">
                    <div class="pol-md-<?php echo $search_columns ?> p-0">
                        ...
                        <input data-submit="disable"  id="sl-search-widget-text" class="form-control asl-search-cntrl isp_ignore border-r-0" placeholder="<?php echo __( 'Enter a Location', 'asl_locator') ?>">
