...
<section id="asl-storelocator" class="asl-cont asl-template-4 asl-layout-<?php echo $all_configs['layout']; ?> asl-bg-<?php echo $all_configs['color_scheme'].$class; ?> asl-text-<?php echo $all_configs['font_color_scheme'] ?>">
    ...
    <div class="asl-overlay" id="map-loading">
        ...
        <div class="sl-loading">
          ...
          <?php echo __('Loading...', 'asl_locator') ?>
        </div>
    </div>
                    ...
                    <div class="asl-search-inner">
                        <div class="sl-form">
                            <div class="asl-addr-search">
                                <input type="text" value="<?php echo $default_addr ?>" id="sl-main-search" class="form-control" placeholder="<?php echo __( 'Enter your address', 'asl_locator') ?>" />
                                <a class="sl-search">
                            ...
                            <div class="asl-geo" title="<?php echo __('Current Location', 'asl_locator') ?>">
                            ...
                            <div class="sl-filter-ddl d-none d-sm-block">
                                <a>
                                    <?php echo __( 'Filter Option','asl_locator') ?>
                                    <span>
    ...
    <!-- Add the table-->
    <div class="sl-container">
        <h3 class="mb-3 text-center"><?php echo __( 'Die Top 10 Abnehmen im Liegen Standorte','asl_locator'); ?><a class="sl-table-toggle"><span><?php echo __( 'Hide Table','asl_locator'); ?></span><span><?php echo __( 'Show Table','asl_locator'); ?></span></a></h3>
        <div class="sl-row">
            <div class="pol">
                <table id="sl-tbl-rating" class="table table-bordered">
                    <thead>
                        <tr>
                          <th scope="pol">&nbsp;</th>
                          <th scope="pol"><?php echo __( 'Standorte','asl_locator'); ?></th>
                          <th scope="pol"><?php echo __( 'Bewertung','asl_locator'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
function make_sl_table(_stores) {
    ...
    if(!_stores.length) {
        table_html += '<tr><td colspan="3"><?php echo __( 'No Rating Found!','asl_locator'); ?></td></tr>';
    }
