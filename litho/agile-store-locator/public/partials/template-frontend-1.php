...
<style type="text/css">
  <?php echo $css_code; ?>
  .asl-cont .onoffswitch .onoffswitch-label .onoffswitch-switch:before {content: "<?php echo __('OPEN', 'asl_locator') ?>" !important;}
  .asl-cont .onoffswitch .onoffswitch-label .onoffswitch-switch:after {content: "<?php echo __('ALL', 'asl_locator') ?>" !important;}
      ...
      <div class="sl-gdpr-cont">
          ...
          <div class="gdpr-ol-bg">
            <div class="gdpr-box">
              ...
              <a class="btn btn-asl" id="sl-btn-gdpr"><?php echo __( 'Load Store Locator','asl_locator') ?></a>
            </div>
          </div>
      </div>
      <?php endif; ?>
      <div class="Filter_section">
        <div class="sl-row">
          <div class="sl-form-group search_filter">
            <label><?php echo __( 'Search Location', 'asl_locator') ?></label>
          ...
          <div class="sl-form-group range_filter hide asl-ddl-filters">
            <label><?php echo __( 'In', 'asl_locator') ?></label>
        ...
        <div class="asl-advance-filters hide">
          <div class="sl-row">
            ...
            <div class="sl-form-group search_filter asl-name-search">
              <div class="asl-filter-cntrl">
                <p class="mb-2"><?php echo __( 'Search Name', 'asl_locator') ?></p>
                <div class="sl-search-group">
                  <input type="text" tabindex="2"  placeholder="<?php echo __( 'Search Name', 'asl_locator') ?>"  class="asl-search-name form-control isp_ignore">
                </div>
              </div>
            </div>
            <?php endif ?>
