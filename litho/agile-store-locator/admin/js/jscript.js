...
(function($, app_engine) {
  ...
  app_engine['pages'] = {
    ...
    manage_attribute: function(_params) {
      ...
      table = $('#tbl_attribute').dataTable({
        ...
        "fnServerParams": function(aoData) {
          ...
          //  add lang
          if(lang_ctrl)
            aoData.push({"name": 'lang',"value": lang_ctrl.value});
    ...
    dashboard: function() {
      ...
      $('#sl-btn-tmpl-backup').bind('click', function(e) {
        ...
        aswal({
          ...
          type: 'question',
          html: '<select class="custom-select" id="sl-tmpl-section-1"><option value="0">Template 0</option><option value="1">Template 1</option><option value="2">Template 2</option><option value="3">Template 3</option><option value="list">Template List</option><option value="form">Store Form</option><option value="store">Store Detail</option><option value="search">Search Widget</option><option value="lead">Lead Form</option></select>',
          showCancelButton: true,
          confirmButtonColor: "#dc3545",
            ...
            for (var s = 0; s < stores_views.length; s++) {
              ...
              stores_views_html += `<li class="list-group-item">
                            <div class="row">
                              ...
                              <div class="col-8">${_store_view.title} - ${_store_view.city}</div>
    ...
    customize_map: function(_asl_map_customize) {
      ...
      app_engine.uploader($form, url_to_upload + '?action=asl_add_kml', function(e, data) {
      ...
      $('.asl-kml-list .asl-trash-icon').bind('click', function(e) {
        ...
        //  Remove the KML File
        ServerCall(ASL_REMOTE.URL + '?action=asl_delete_kml', { data_: $(this).attr('data-file') }, function(_response) {
    ...
    add_store: function(_is_edit, _store) {
      ...
      if(lang_ctrl && lang_ctrl.value != ASL_REMOTE.sl_lang) {
        window.location.search += '&lang=' + lang_ctrl.value;
        return;
      }
      ...
      app_engine.uploader($form_marker, url_to_upload + '?action=asl_add_markers', function(_e, _data) {
    ...
    user_setting: function(_configs) {
      ...
      $('#btn-asl-load_ctemp').bind('click', function(e) {
        ...
        ServerCall(ASL_REMOTE.URL + '?action=asl_load_custom_template', {template: template , section: section}, function(_response) {
      ...
      $('#btn-asl-save_ctemp').bind('click', function(e) {
        ...
        ServerCall(ASL_REMOTE.URL + '?action=asl_save_custom_template', {template: template , section: section,html: html}, function(_response) {
      ...
      $('#btn-asl-reset_ctemp').bind('click', function(e) {
        ...
        ServerCall(ASL_REMOTE.URL + '?action=asl_reset_custom_template', {template: template , section: section}, function(_response) {
      ...
      $('.asl-user-setting a[data-toggle="pill"]').on('shown.bs.tab', function (e) {
      ...
      function update_cache(_status, _lang, _callback) {
        ...
        ServerCall(ASL_REMOTE.URL + "?action=asl_cache_status", {status: _status, 'lang': _lang, 'content': cache_data, 'stype': 'cache'}, function(_response) {
    ...
    ui_template: function(_configs) {
      ...
      $('#btn-asl-load_uitemp').bind('click', function(e) {
        ...
        ServerCall(ASL_REMOTE.URL + '?action=asl_load_ui_settings', {template: template}, function(_response) {
      ...
      $('#btn-asl-save_uitemp').bind('click', function(e) {
        ...
        ServerCall(ASL_REMOTE.URL + '?action=asl_save_ui_settings', {template: template,formData: formData}, function(_response) {
    ...
    import_store: function() {
      ...
      $('.btn-asl-import_store').bind('click', function(e) {
        ...
        var _params = { data_: $(this).attr('data-id') };
      ...
      $('#asl-duplicate-remove').bind('click', function(e) {
        ...
        aswal({
          ...
          ServerCall(ASL_REMOTE.URL + "?action=asl_remove_duplicates", {}, function(_response) {
