		...
		<div class="row asl-inner-cont">
			<div class="col-md-12">
				<div class="card p-0 mb-4">
					<h3 class="card-title"><?php echo esc_attr__('Create Store','asl_admin') ?><?php echo AgileStoreLocator_Helper::getLangControl(); ?></h3>
          <div class="card-body">
              <form id="frm-addstore">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <div class="form-group">
                        <label  for="txt_brand"><?php echo esc_attr__('Speciality','asl_admin') ?></label>
  											    ...
  											    <tr>
  											      ...
  											      <td colspan="3">
  											        <div class="asl-all-day-times" data-day="mon">
  									                  ...
  									                  <input type="text" value="9:30 AM" class="form-control asl-start-time asltimepicker validate[required,funcCall[ASLmatchTime]]" placeholder="<?php echo esc_attr__('Start Time','asl_admin') ?>">
  									                ...
  									                <div class="input-group bootstrap-asltimepicker">
  									                  <input type="text" value="6:30 PM" class="form-control asl-end-time asltimepicker validate[required]" placeholder="<?php echo esc_attr__('End Time','asl_admin') ?>">
  									                  <span class="input-group-append add-on"><span class="input-group-text"><svg width="16" height="16"><use xlink:href="#i-clock"></use></svg></span></span>
  									                </div>
                  ...
                  <div class="row">
                  	<div class="col-12 mt-3">
                  		<button type="button" class="float-right btn btn-primary mrg-r-10" data-loading-text="<?php echo esc_attr__('Saving Store...','asl_admin') ?>" data-completed-text="<?php echo esc_attr__('Store Saved','asl_admin') ?>" id="btn-asl-add"><?php echo esc_attr__('Add Store','asl_admin') ?></button>
                  	</div>
                  </div>
              </form>
          </div>
