    ...
    <div class="row asl-inner-cont">
      <div class="col-md-12">
        <div class="card p-0 mb-4">
          <h3 class="card-title"><?php echo esc_attr__('Manage Markers','asl_admin') ?></h3>
          <div class="card-body">
          <?php if(!is_writable(ASL_PLUGIN_PATH.'public/icon')): ?>
            <h6  class="alert alert-danger" style="font-size: 14px"><?php echo ASL_PLUGIN_PATH.'public/icon' ?> <= <?php echo esc_attr__('Directory is not writable, Marker Image Upload will Fail, Make directory writable.','asl_admin') ?></h6>
          <?php endif; ?>
            <div class="row">
              <div class="col-md-12 ralign">
                <a target="_blank" href="https://agilestorelocator.com/marker-generator-tool/" class="btn btn-primary mrg-r-10"><?php echo esc_attr__('Generate Tool','asl_admin') ?></a>
                ...
                <button type="button" id="btn-asl-new-c" class="btn btn-success mrg-r-10"><i><svg width="13" height="13"><use xlink:href="#i-plus"></use></svg></i><?php echo esc_attr__('New Marker','asl_admin') ?></button>
              </div>
            </div>
            <div class="col-sm-12">
              	...
              	<table id="tbl_markers" class="display table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th align="center"><input class="form-control" type="text" data-id="id"  placeholder="<?php echo esc_attr__('Search ID','asl_admin') ?>"  /></th>
                        <th align="center"><input class="form-control" type="text" data-id="marker_name"  placeholder="<?php echo esc_attr__('Search Name','asl_admin') ?>"  /></th>
                        <th align="center">&nbsp;</th>
                        <th align="center">&nbsp;</th>
                      </tr>
                      <tr>
                        <th align="center"><a class="select-all"><?php echo esc_attr__('Select All','asl_admin') ?></a></th>
                        <th align="center"><?php echo esc_attr__('Marker ID','asl_admin') ?></th>
  ...
  <div class="smodal-dialog" role="document">
    <div class="smodal-content">
      ...
      <div class="smodal-header">
        <h5 class="smodal-title"><?php echo esc_attr__('Update Marker','asl_admin') ?></h5>
      ...
      <div class="smodal-body">
        ...
        <div class="smodal-footer">
          <button class="btn btn-primary btn-start mrg-r-15" id="btn-asl-update-markers"   type="button" data-loading-text="<?php echo esc_attr__('Submitting ...','asl_admin') ?>"><?php echo esc_attr__('Update Marker','asl_admin') ?></button>
