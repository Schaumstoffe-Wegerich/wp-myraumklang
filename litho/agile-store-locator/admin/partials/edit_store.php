		...
		<div class="row asl-inner-cont">
			<div class="col-md-12">
				<div class="card p-0 mb-4">
					<h3 class="card-title"><?php echo esc_attr__('Edit Store','asl_admin') ?><?php echo AgileStoreLocator_Helper::getLangControl(); ?></h3>
          <div class="card-body">
              <form id="frm-addstore">
              		<div class="row">
										<div class="col-md-8">
											<div class="alert alert-dismissable alert-danger hide">
												...
												<h4><?php echo esc_attr__('Alert!','asl_admin') ?></h4> <strong><?php echo esc_attr__('Warning!','asl_admin') ?></strong><?php echo esc_attr__('Best check yourself ','asl_admin') ?><a href="#" class="alert-link"><?php echo esc_attr__('alert link','asl_admin') ?></a>
											</div>
										</div>
									</div>
              		<input type="hidden" id="update_id" value="<?php echo esc_attr($store->id) ?>" />
              		<div class="card-title mb-3"><?php echo esc_attr__('Store Details','asl_admin') ?></div>
                  <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_title"><?php echo esc_attr__('Title','asl_admin') ?></label>
                        <input type="text" id="txt_title" value="<?php echo esc_attr($store->title) ?>" name="data[title]" class="form-control">
                    </div>

                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_website"><?php echo esc_attr__('Website','asl_admin') ?></label>
                    ...
                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_description"><?php echo esc_attr__('Description','asl_admin') ?></label>
                    ...
                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_description_2"><?php echo esc_attr__('Additional Description','asl_admin') ?></label>
                    ...
                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_phone"><?php echo esc_attr__('Phone','asl_admin') ?></label>
                        <input type="text" id="txt_phone" value="<?php echo esc_attr($store->phone) ?>" name="data[phone]" class="form-control">
                        
                    </div>
                    
                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_fax"><?php echo esc_attr__('Fax','asl_admin') ?></label>
                        <input type="text"  id="txt_fax" value="<?php echo esc_attr($store->fax) ?>" name="data[fax]" class="form-control">
                    </div>
                  </div>

                  <div class="card-title mb-3 mt-3"><?php echo esc_attr__('Store Address','asl_admin') ?></div>
                  <div class="row">

                  	<div class="col-md-6 form-group mb-3">
                        <label for="txt_email"><?php echo esc_attr__('Email','asl_admin') ?></label>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group mb-3">
                            <label for="asl_txt_lat"><?php echo esc_attr__('Latitude','asl_admin') ?></label>
                          ...
                          <div class="form-group mb-3">
                            <label for="asl_txt_lng"><?php echo esc_attr__('Longitude','asl_admin') ?></label>
                          ...
                          <div class="form-group">
                              <a id="lnk-edit-coord" class="btn float-right btn-warning"><?php echo esc_attr__('Change Coordinates','asl_admin') ?></a>
                          </div>
                        </div>
                        <div class="col-12">
                  ...
                  <div class="card-title mt-3 mb-3"><?php echo esc_attr__('Other Details','asl_admin') ?></div>
                  <div class="row">
                  	<div class="col-md-6 form-group mb-3">
                    	<div class="form-group">
											  <label for="ddl-asl-markers"><?php echo esc_attr__('Marker','asl_admin') ?></label>
											    ...
											    <button type="button" class="btn btn-success" data-toggle="smodal" data-target="#addmarkermodel"><?php echo esc_attr__('New Marker','asl_admin') ?></button>
											    </div>
											</div>
                    </div>

                    <div class="col-md-6 form-group mb-3">
										  <label for="ddl-asl-logos"><?php echo esc_attr__('Logo','asl_admin') ?></label>
										  <div class="input-group">
										    <div id="ddl-asl-logos"></div>
											  <button type="button" class="btn btn-success" data-toggle="smodal" data-target="#addimagemodel"><?php echo esc_attr__('New Logo','asl_admin') ?></button>
										  </div>
										</div>
										<div class="col-md-6 form-group mb-3">
                      <label for="ddl_categories"><?php echo esc_attr__('Category','asl_admin') ?></label>
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <label for="txt_special"><?php echo esc_attr__('Special','asl_admin') ?></label>
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <label for="txt_brand"><?php echo esc_attr__('Brand','asl_admin') ?></label>
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <label for="txt-ordering"><?php echo esc_attr__('Priority Order','asl_admin') ?></label>
                      ...
                      <small class="form-text text-muted"><?php echo esc_attr__('Descending Order for the list, higher number on top.','asl_admin') ?></small>
                    </div>
                    ...
                    <div class="col-md-6 form-group mb-3 d-flex align-items-center">
                      <div class="custom-control custom-checkbox">
											  ...
											  <label class="custom-control-label" for="chk_disabled"><?php echo esc_attr__('Disabled','asl_admin') ?></label>
											</div>
                    </div>
                  </div>
                  <div class="card-title mt-3 mb-3"><?php echo esc_attr__('Store Timing','asl_admin') ?>
                    <div class="float-right">
                      <a id="asl-time-cp" class="btn btn-info btn-sm" title="<?php echo esc_attr__('Copy/Paste Monday Timing','asl_admin') ?>"><?php echo esc_attr__('Same Everyday','asl_admin') ?></a>
                    </div>
                  </div>
                  <?php
                  ...
                  <div class="row">
                      ...
                      <div class="table-responsive">
  	                  	<table class="table table-bordered table-stripped asl-time-details">
  											  <tbody>
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Monday','asl_admin') ?></span></td>
  											      <td colspan="3">
  											        <div class="asl-all-day-times" data-day="mon">
  									                  ...
  									                  <input type="text" value="<?php echo esc_attr($o_hour[0]) ?>" class="form-control asl-start-time asltimepicker validate[required,funcCall[ASLmatchTime]]" placeholder="<?php echo esc_attr__('Start Time','asl_admin') ?>">
  									                ...
  									                <div class="input-group bootstrap-asltimepicker">
  									                  <input type="text" value="<?php echo esc_attr($o_hour[1]) ?>" class="form-control asl-end-time asltimepicker validate[required]" placeholder="<?php echo esc_attr__('End Time','asl_admin') ?>">
  									                  <span class="input-group-append add-on"><span class="input-group-text"><svg width="16" height="16"><use xlink:href="#i-clock"></use></svg></span></span>
  									                </div>
  								                    ...
  								                    <span><?php echo esc_attr__('Closed','asl_admin') ?></span>
  								                    <span><?php echo esc_attr__('Open 24 Hour','asl_admin') ?></span>
  										              </div>
  											          </div>
  											        </div>
  											      </td>
  											    ...
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Tuesday','asl_admin') ?></span></td>
  											      <td colspan="3">
  											    ...
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Wednesday','asl_admin') ?></span></td>
  											      <td colspan="3">
                                      ...
                                      <svg width="16" height="16"><use xlink:href="#i-trash"></use></svg>
  											    ...
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Thursday','asl_admin') ?></span></td>
  											      <td colspan="3">
  											    ...
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Friday','asl_admin') ?></span></td>
  											      <td colspan="3">
  											    ...
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Saturday','asl_admin') ?></span></td>
  											      <td colspan="3">
  											    ...
  											    <tr>
  											      <td colspan="1"><span class="lbl-day"><?php echo esc_attr__('Sunday','asl_admin') ?></span></td>
  											      <td colspan="3">
                  ...
                  <div class="row">
                  	<div class="col-12 mt-3">
                  		<button type="button" class="float-right btn btn-primary mrg-r-10" data-loading-text="<?php echo esc_attr__('Saving Store...','asl_admin') ?>" data-completed-text="<?php echo esc_attr__('Store Saved','asl_admin') ?>" id="btn-asl-add"><?php echo esc_attr__('Update Store','asl_admin') ?></button>
                  	</div>
                  </div>
              </form>
          </div>
  ...
  <div class="smodal fade" tabindex="-1" id="addimagemodel" role="dialog">
    <div class="smodal-dialog" role="document">
      <div class="smodal-content">
        ...
        <div class="smodal-header">
          <h5 class="smodal-title"><?php echo esc_attr__('Upload Logo','asl_admin') ?></h5>
        ...
        <div class="smodal-body">
          ...
          <div class="col-md-12 form-group mb-3">
              <label for="txt_logo-name"><?php echo esc_attr__('Name','asl_admin') ?></label>
              <input type="text" id="txt_logo-name" name="data[logo_name]" placeholder="<?php echo esc_attr__('Logo Name','asl_admin') ?>" class="form-control">
          </div>
          <div class="col-md-12 form-group mb-3" id="drop-zone">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text"><?php echo esc_attr__('Logo','asl_admin') ?></span>
              </div>
              <div class="custom-file">
                <input name="files" type="file" class="custom-file-input" accept=".jpg,.png,.jpeg,.gif,.JPG" id="file-logo">
                <label  class="custom-file-label" for="file-logo"><?php echo esc_attr__('File Path...','asl_admin') ?></label>
              </div>
            </div>
          </div>
          <div class="form-group">
        ...
        <div class="smodal-footer">
          <button type="button" data-loading-text="<?php echo esc_attr__('Submitting ...','asl_admin') ?>" class="btn btn-start btn-primary"><?php echo esc_attr__('Upload','asl_admin') ?></button>
          <button type="button" class="btn btn-secondary" data-dismiss="smodal"><?php echo esc_attr__('Close','asl_admin') ?></button>
        </div>
    ...
    <div class="smodal-dialog" role="document">
      <div class="smodal-content">
        ...
        <div class="smodal-header">
          <h5 class="smodal-title"><?php echo esc_attr__('Upload Marker','asl_admin') ?></h5>
          <button type="button" class="close" data-dismiss="smodal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="smodal-body">
	        <div class="col-md-12 form-group mb-3">
              <label for="txt_marker-name"><?php echo esc_attr__('Marker Name','asl_admin') ?></label>
          ...
          <div class="col-md-12 form-group mb-3" id="drop-zone-2">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text"><?php echo esc_attr__('Icon','asl_admin') ?></span>
              </div>
              <div class="custom-file">
                <input name="files" type="file" class="custom-file-input" accept=".jpg,.png,.jpeg,.gif,.JPG" id="file-logo-2">
                <label  class="custom-file-label" for="file-logo-2"><?php echo esc_attr__('File Path...','asl_admin') ?></label>
              </div>
            </div>
          </div>
          <div class="form-group">
	      ...
	      <div class="smodal-footer">
          <button type="button" data-loading-text="<?php echo esc_attr__('Submitting ...','asl_admin') ?>" class="btn btn-start btn-primary"><?php echo esc_attr__('Upload','asl_admin') ?></button>
	        <button type="button" class="btn btn-default" data-dismiss="smodal"><?php echo esc_attr__('Close','asl_admin') ?></button>
	      </div>
	    </div>
	  </div>
	</div>
