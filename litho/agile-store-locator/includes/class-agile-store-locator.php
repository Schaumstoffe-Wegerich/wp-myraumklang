...
class AgileStoreLocator {
	...
	public function __construct() {
		...
		//	FRONTEND Request
		$this->public_request = new AgileStoreLocator_Request();
    ...
    add_action( 'asl_import_cron', array($this->plugin_admin, 'execute_the_cron'));
	}
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once ASL_PLUGIN_PATH . 'includes/frontend/class-agile-store-locator-public.php';


		/**
		 * The class responsible for defining all public ajax requests
		 * side of the site.
		 */
		require_once ASL_PLUGIN_PATH . 'includes/frontend/class-agile-store-locator-request.php';
	...
	private function define_admin_hooks() {
		...
		add_action('wp_ajax_asl_remove_duplicates', array($this->plugin_admin, 'remove_duplicates'));	
		...
		add_action('wp_ajax_asl_load_custom_template', array($this->plugin_admin, 'load_custom_template'));
		add_action('wp_ajax_asl_save_custom_template', array($this->plugin_admin, 'save_custom_template'));
		add_action('wp_ajax_asl_reset_custom_template', array($this->plugin_admin, 'reset_custom_template'));
		...
		add_action('wp_ajax_asl_cache_status', array($this->plugin_admin, 'manage_cache'));
		add_action('wp_ajax_asl_load_ui_settings', array($this->plugin_admin, 'load_ui_settings'));
		add_action('wp_ajax_asl_save_ui_settings', array($this->plugin_admin, 'save_ui_settings'));
		...
		//	Upload the KML file
		add_action('wp_ajax_asl_add_kml', array($this->plugin_admin, 'upload_kml_file'));
		add_action('wp_ajax_asl_delete_kml', array($this->plugin_admin, 'remove_kml_file'));
	...
	public function add_admin_menu() {
		...
		if (current_user_can(ASL_PERMISSION)) {
			...
			add_Menu_page('Agile Store Locator', esc_attr__('A Store Locator','asl_admin'), ASL_PERMISSION, 'asl-plugin', array($this->plugin_admin,'admin_plugin_settings'),$svg);
			add_submenu_page( 'asl-plugin', esc_attr__('Dashboard','asl_admin'), esc_attr__('Dashboard','asl_admin'), ASL_PERMISSION, 'agile-dashboard', array($this->plugin_admin,'admin_dashboard'));
			add_submenu_page( 'asl-plugin', esc_attr__('Create New Store','asl_admin'), esc_attr__('Add New Store','asl_admin'), ASL_PERMISSION, 'create-agile-store', array($this->plugin_admin,'admin_add_new_store'));
			add_submenu_page( 'asl-plugin', esc_attr__('Manage Markers','asl_admin'), esc_attr__('Manage Markers','asl_admin'), ASL_PERMISSION, 'manage-store-markers', array($this->plugin_admin,'admin_store_markers'));
			add_submenu_page( 'asl-plugin', esc_attr__('Manage Logos','asl_admin'), esc_attr__('Manage Logos','asl_admin'), ASL_PERMISSION, 'manage-store-logos', array($this->plugin_admin,'admin_store_logos'));
			add_submenu_page( 'asl-plugin', esc_attr__('Manage Stores','asl_admin'), esc_attr__('Manage Stores','asl_admin'), ASL_PERMISSION, 'manage-agile-store', array($this->plugin_admin,'admin_manage_store'));
			add_submenu_page( 'asl-plugin', esc_attr__('Manage Categories','asl_admin'), esc_attr__('Manage Categories','asl_admin'), ASL_PERMISSION, 'manage-asl-categories', array($this->plugin_admin,'admin_manage_categories'));
			add_submenu_page( 'asl-plugin', esc_attr__('Manage Brands','asl_admin'), esc_attr__('Manage Brands','asl_admin'), ASL_PERMISSION, 'manage-asl-filter', array($this->plugin_admin,'admin_manage_attribute'));
			add_submenu_page( 'asl-plugin', esc_attr__('Manage Specialities','asl_admin'), esc_attr__('Manage Specialities','asl_admin'), ASL_PERMISSION, 'manage-asl-specials', array($this->plugin_admin, 'admin_manage_specials'));
			add_submenu_page( 'asl-plugin', esc_attr__('Import/Export Stores','asl_admin'), esc_attr__('Import/Export Stores','asl_admin'), ASL_PERMISSION, 'import-store-list', array($this->plugin_admin,'admin_import_stores'));
			add_submenu_page( 'asl-plugin', esc_attr__('Customize Map','asl_admin'), esc_attr__('Customize Map','asl_admin'), ASL_PERMISSION, 'customize-map', array($this->plugin_admin,'admin_customize_map'));
			add_submenu_page( 'asl-plugin', esc_attr__('ASL Settings','asl_admin'), esc_attr__('ASL Settings','asl_admin'), ASL_PERMISSION, 'user-settings', array($this->plugin_admin,'admin_user_settings'));
			add_submenu_page( 'options-writing.php', esc_attr__('Agile Store Locator UI Customizer','asl_admin'), esc_attr__('Agile Store Locator UI Customizer','asl_admin'), ASL_PERMISSION, 'sl-ui-customizer', array($this->plugin_admin, 'admin_ui_customizer'));

			add_submenu_page('asl-plugin-edit', esc_attr__('Edit Store','asl_admin'), esc_attr__('Edit Store','asl_admin'), ASL_PERMISSION, 'edit-agile-store', array($this->plugin_admin,'edit_store'));
