...
class AgileStoreLocator_Activator {
	...
	public static function activate() {
		...
		AgileStoreLocator_Activator::add_cron_job();
	}
    ...
    /*
    $plugin_admin = new AgileStoreLocator_Admin( 'agile-store-locator', ASL_CVERSION);

    $plugin_admin->set_setting(time(), 'cron_timestamp');
    */
	}
