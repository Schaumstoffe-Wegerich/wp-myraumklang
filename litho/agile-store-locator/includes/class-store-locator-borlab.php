 ...
 */
class AgileStoreLocator_Borlab {


	private $blocker_id = 'wpstorelocatorplugin';
	...
	public function initialize() {
		...
		$borlab_blocker = $this->get_the_blocker();
	...
	public function blocker_content($content, $attributes = []) {
		...
		if($blocker) {
			...
			$initJS						= 'console.log("GDPR Accepted");asl_gdpr(true);';
	...
	/**
	 * [get_the_blocker Get the Borlab Blocker by ID]
	 * @return [type] [description]
	 */
